...
const StarRating = ({ value,htmlFor ,isActive, onClick}) => {
  return (
    <div className={`star ${isActive ? "active":""}`}>

    <input type="radio" id={ htmlFor} name="rate" value={value} onChange={onClick} />
    <label htmlFor={htmlFor} title="text">
      <svg
        viewBox="0 0 576 512"
        height="1em"
      ...
      >
        ...
        //   strokeWidth="25" // Épaisseur du contour
        />
      </svg>
    </label>
    </div>
